...
type FormMeetingProps = {
    mode?: "add" | "edit"
    id?: string
}

export default function FormMeeting({ mode = "add", id }: FormMeetingProps) {
        ...
        if (mode === "edit" && id) {
            ...
            http.get(`/session/${id}`)
                .then((response) => {
                    ...
                    form.reset({
                        record_type: data.record_type || "meeting",
                        theme: data.theme || "",
                ...
                .catch((error) => {
                    ...
                    router.push("/group-home/meeting")
                })
                .finally(() => {
                    setLoading(false)
                })
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        request
            .then((response) => {
                ...
                router.push("/group-home/meeting")
                toast.success(mode === "edit" ? "議事録に追加されました。" : "スタッフ会議議事録を登録しました。", {
                    duration: 3000,
                    position: "top-right",
                })
            })
            .catch((error) => {
                const errorMessage =
                    ...
                    (mode === "edit" ? "議事録に追加されました。" : "スタッフ会議議事録を登録しました。")
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>テーマ<RequiredCharacter /></FormLabel>
                                    <FormControl>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-col">
                                        <FormLabel>開催日<RequiredCharacter /></FormLabel>
                                        <FormControl>
                            ...
                            <div className="flex gap-4">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-col">
                                            <FormLabel>開始時間<RequiredCharacter /></FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-col">
                                            <FormLabel>終了時間<RequiredCharacter /></FormLabel>
                                            <FormControl>
                                                <Input type="time" {...field} className="w-auto" />
                                            </FormControl>
                                            <div className="min-h-[20px]">
                            ...
                            <Signature
                                fields={[
                                    ...
                                    },
                                    {
                                        ...
                                        onChange: (value) => form.setValue("signature.child_support_manager_signature", value),
                                        disabled: loading,
                                    },
                                    {
                        ...
                        <div className="flex justify-end gap-2">
                            <UICancelButton onClick={() => router.push("/group-home/meeting")} disabled={loading}>
                                キャンセル
                            </UICancelButton>
