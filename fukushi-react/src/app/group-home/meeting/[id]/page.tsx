...
export default function ViewMeeting({ params }: { params: Promise<{ id: string }> }) {
    const [data, setData] = useState<MeetingProps | null>(null)
    ...
    return (
        <>
            <div className="flex items-center justify-between mb-6">
                <HeadingPage title="スタッフ会議議事録詳細" />
                <div className="flex gap-3">
                    <Button variant="outline" onClick={() => router.push("/group-home/meeting")}>
                        <ArrowLeft size={16} className="mr-2" />
                        戻る
                    </Button>
                    <Button onClick={() => router.push(`/group-home/meeting/edit/${resolvedParams.id}`)}>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 p-3 bg-gray-50 rounded-md min-h-[100px]">
                            <p className="text-sm text-gray-900 whitespace-wrap break-all">
