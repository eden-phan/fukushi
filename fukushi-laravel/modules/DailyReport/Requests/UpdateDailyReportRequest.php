...
class UpdateDailyReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'daily_report_staffs.*.id' => 'nullable|exists:daily_report_staffs,id',
            ...
            'daily_report_service_users.*.id' => 'nullable|exists:daily_report_service_users,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'daily_report_staffs.*.id.exists' => '指定されたスタッフエントリーが存在しません。',
            ...
            'daily_report_service_users.*.id.exists' => '指定されたサービス利用者エントリーが存在しません。',
