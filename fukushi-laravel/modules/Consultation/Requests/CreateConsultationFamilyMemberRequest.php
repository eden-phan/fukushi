...
class CreateConsultationFamilyMemberRequest extends FormRequest
{
    ...
    {
        return [
            'consultation.facility_id' => 'required|integer|exists:facilities,id',
            ...
            'consultation.created_by' => 'required|integer|exists:users,id',
