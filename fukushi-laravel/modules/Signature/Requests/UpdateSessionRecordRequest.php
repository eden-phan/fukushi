...
class UpdateSessionRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'admin_signature' => 'require|string|max:5',
            'child_support_manager_signature' => 'require|string|max:5',
            'recorder_signature' => 'require|string|max:5',
        ];
    }
